 ...
 */
final class Version20260219081606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card CHANGE effect effect LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card CHANGE effect effect LONGTEXT NOT NULL');
