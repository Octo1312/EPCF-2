 ...
 */
final class Version20260219081352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card CHANGE strength strength INT DEFAULT NULL, CHANGE toughness toughness INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card CHANGE strength strength INT NOT NULL, CHANGE toughness toughness INT NOT NULL');
